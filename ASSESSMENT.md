...
Γöé  Frontend   Γöé ΓöÇΓöÇΓöÇΓû║ Γöé Backend API Γöé
ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ      ΓööΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓö¼ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÿ
                 ...
                 Γû╝                     Γû╝
          ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ       ΓöîΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÉ
          Γöé PostgreSQL  Γöé       Γöé    Redis    Γöé
...
|-------------------------------|:-----------:|:---------:|:---------------:|:-------:|
| Manage organizations          | Γ£ô           |           |                 |         |
| Manage organization users     | Γ£ô           | Γ£ô         |                 |         |
| Create projects               | Γ£ô           | Γ£ô         | Γ£ô               |         |
| Manage project tasks          | Γ£ô           | Γ£ô         | Γ£ô               |         |
| Create own tasks              | Γ£ô           | Γ£ô         | Γ£ô               | Γ£ô       |
| Update permitted tasks        | Γ£ô           | Γ£ô         | Γ£ô               | Γ£ô       |
| Delete permitted tasks        | Γ£ô           | Γ£ô         | Γ£ô               |         |
| View organization analytics   | Γ£ô           | Γ£ô         | Γ£ô               | Limited |
...
API
 ...
 ΓööΓöÇΓöÇΓû║ Queue
      ...
      Worker
        Γöé
        ΓööΓöÇΓöÇΓû║ Notification / Processing
```
...
``` text
User A ΓåÆ Organization A ΓåÆ Task A
```

cannot access:

``` text
User A ΓåÆ Organization B ΓåÆ Task B
```
...
Γö£ΓöÇΓöÇ keycloak/
Γö£ΓöÇΓöÇ scripts/
Γöé   Γö£ΓöÇΓöÇ backup.sh
Γöé   ΓööΓöÇΓöÇ restore.sh
Γö£ΓöÇΓöÇ docs/
Γöé   Γö£ΓöÇΓöÇ ARCHITECTURE.md
Γöé   Γö£ΓöÇΓöÇ SECURITY.md
Γöé   Γö£ΓöÇΓöÇ DATABASE.md
Γöé   Γö£ΓöÇΓöÇ DISASTER_RECOVERY.md
Γöé   ΓööΓöÇΓöÇ ADR/
Γö£ΓöÇΓöÇ docker-compose.yml
Γö£ΓöÇΓöÇ .env.example
Γö£ΓöÇΓöÇ README.md
ΓööΓöÇΓöÇ AI_USAGE.md
```
